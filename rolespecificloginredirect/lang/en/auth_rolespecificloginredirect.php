...
$string['auth_rolespecificloginredirectdescription'] = '<p>Redirects the user to a specific page, depending on his role.</p>';
$string['auth_rolespecificloginredirectsettings'] = 'Settings';
$string['pluginname'] = 'Role specific redirect';
$string['roles_small'] = 'roles';
$string['roles'] = 'Roles: ';
$string['urls_small'] = 'urls';
$string['urls'] = 'Link to be redirected to: ';
$string['url_example'] = 'e.g. /course/view.php?id=2';
$string['url_default'] = '/my';
$string['pagenotfound'] = 'This page was not found.';